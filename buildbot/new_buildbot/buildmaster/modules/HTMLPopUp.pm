...
# $Author: mikeleib $ 
# $Source: /cvs/gnome/ooo-build/scratch/buildbot/master_config_files/modules/HTMLPopUp.pm,v $ 
# $Name:  $ 
...
#use lib '/stripe/tinderbox/local_conf',
#   '/stripe/tinderbox/default_conf',
#   '/stripe/tinderbox/lib',
