...
# $Revision: 1.1 $
# $Date: 2006/08/07 23:24:26 $
# $Author: mikeleib $
# $Source: /cvs/gnome/ooo-build/scratch/buildbot/master_config_files/modules/HTMLPopUp/OverLib.pm,v $
# $Name:  $
...
#use lib '/var/tinderbox/local_conf',
#   '/var/tinderbox/default_conf',
#   '/var/tinderbox/lib',
...
//\  them as well.
//   $Revision: 1.1 $                $Date: 2006/08/07 23:24:26 $
//\/////
//\mini
...
<TR><TD>
   <TABLE BORDER=0 CELLPADDING=0 CELLSPACING=2>
      <TR><TD VALIGN=TOP ALIGN=CENTER NOWRAP>
           <FONT SIZE=\"+3\"><B><NOBR>$heading</NOBR></B></FONT>
      </TD></TR>
