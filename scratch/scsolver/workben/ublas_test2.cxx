...
typedef bnu::zero_matrix<double> MxZero;
...
void factorize( const Mx& mxA, Mx& mxL, Mx& mxU, Mx& mxP )
{
	...
	for ( size_t k = 0; k < n - 1; ++k )
	{
		...
		swap( cnP.at( k ), cnP.at( nSwapRowId ) );
	...
	static const MxIdentity I( n, n );
	static const MxZero N( n, n );
	Mx L( I ), U( N ), P( N );
	...
	vector<size_t>::const_iterator it, itBeg = cnP.begin(), itEnd = cnP.end();
	for ( it = itBeg; it != itEnd; ++it )
	{
